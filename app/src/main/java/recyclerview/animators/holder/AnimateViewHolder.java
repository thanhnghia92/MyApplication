package recyclerview.animators.holder;
...
public interface AnimateViewHolder {
  ...
  void preAnimateChangeImpl(final RecyclerView.ViewHolder holder);

  void animateChangeImpl(final RecyclerView.ViewHolder holder, ViewPropertyAnimatorListener listener);
